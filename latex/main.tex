...
\begin{table}[h!]
  ...
  \hline
  BN & log & Normalización & dropout & \begin{tabular}[c]{@{}c@{}}Acc.\\ Mejor Val\end{tabular} & \begin{tabular}[c]{@{}c@{}}Acc.\\ Entrenamiento\end{tabular} \\ \hline\hline
...
% En la Fig. \ref{fig:estudio_res} se muestra gráficamente esta tabla pero añadiéndole color que nos permite ver de manera inmediata algunos patrones.
